...
const faqData = [
  ...
  {
    question: 'Will you help me find clients for my mentorship business?',
    answer: '',
  },
];
...
export default function FaqAccordion() {
  return (
    <section className='max-w-7xl mx-auto my-10'>
      <div className='mx-4 bg-[#ECF0F5] rounded-3xl px-6 py-10'>
        <h2 className='text-2xl sm:text-3xl font-semibold mb-10 text-primary'>
          FAQs:
        </h2>
