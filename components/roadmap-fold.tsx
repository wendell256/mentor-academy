...
export default function RoadmapSection() {
  return (
    <section className=' max-w-7xl mx-auto'>
      <div className='bg-gradient-to-t from-black/90 to-[#0567FE] text-white py-20 px-6 rounded-3xl mx-4'>
        <div className='text-center mb-10 space-y-3'>
          ...
          <p className='max-w-xl mx-auto text-white/80 text-sm'>
            Mentor Academy is unlike any other course or program out there.{' '}
            <br /> This is a hands-on complete business launch system with a
            clear, <br />
