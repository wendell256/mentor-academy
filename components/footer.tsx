  ...
  return (
    <footer className='bg-chart-5 text-foreground pt-16'>
      ...
      <div className='max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-6 gap-10'>
        ...
        <div className='md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm text-foreground'>
      ...
      <div className='border-t border-white/10 text-sm py-6 px-6 flex flex-col md:flex-row justify-between max-w-6xl mx-auto text-foreground'>
